...
INSERT INTO books(title,author,publisher,cover_path,memo,progress_unit,progress_time_bucket,mindmap_depth,mindmap_root,chapter_chart_style,created_by,created_at_utc,updated_at_utc)
VALUES('サンプル図書','サンプル作者','サンプル発行機関','','管理システムと進展ページの動作確認用サンプルです。','section','daily','section','chapter','rounded',@sample_created_by,UTC_TIMESTAMP(6),UTC_TIMESTAMP(6));
